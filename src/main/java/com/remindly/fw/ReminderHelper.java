...
public class ReminderHelper extends BaseHelper {
  ...
  public void selectDate(String period, String month, int number, int index, String period2,
      String year) {
    tap(By.id("date"));
  ...
  public void addReminderInterval(String number) {
    tap(By.id("RepeatNo"));
    pause(500);
  ...
  public void getTypeOfRepetition(String period) {
    swipe(0.8, 0.5);
    tap(By.id("RepeatType"));
    pause(500);
    tap(By.xpath("//*[@text='" + period + "']"));
